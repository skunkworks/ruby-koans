...
class AboutToStr < Neo::Koan
  ...
  # Just learned that sending the wrong type leads to a TypeError exception
  ...
  # This koan demonstrates the difference between to_s and to_str. Both of them
  # return a string representation of an object, but to_str can be overridden
  # to allow an object to be substituted where strings are expected.
