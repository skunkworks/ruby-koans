...
class AboutScope < Neo::Koan
  ...
  # Pretty familiar with specifying namespace with the scope operator
  ...
  # Makes sense that Ruby gives preference to the current scope
  ...
  # const_get and instance_variable_get... makes sense. However, it seems
  # that consts are not associated with instances but with classes.
  ...
  # Constants come back as symbols. Of course -- just like how methods will
  # store method names as symbols.
