...
class AboutInheritance < Neo::Koan
  ...
  # Didn't realize that calling the parent was as simple as "super"
  ...
  # Not surprising that this wouldn't work. super is a call to the method in
  # the superclass and other ancestors.
  #
  # Note that super by itself forwards arguments from the invoking method.
  # To call it with no arguments, use super(). To give it new arguments,
  # specify them manually (e.g. super(a, b, c)).
